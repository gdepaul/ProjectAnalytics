...
public class CompleteClient extends JFrame{
	...
	public CompleteClient(HashMap<String, Club> clubs, Map<String, Deque<Dispatch<DispatchServer>>> histories){
...
//			
	...
	private void setupGUI() {
		...
		this.panel_history = new ServerPanel_Histories(this.clubs,this.histories, out);
...
//	}
	public void update(List<Club> clubs, List<String> availableFS, List<String> dispatchedFS) {
		...
		((ServerPanel_Histories)this.panel_history).updatePanel(this.clubs,this.histories);
